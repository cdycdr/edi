  ...
  public class BrowserViewModel : Base.ViewModelBase, IBrowserViewModel
  {
    ...
    public BrowserViewModel()
    {
      ...
      Environment.GetLogicalDrives().ToList().ForEach(it =>
      {
        try
        {
          ...
          {
            this.Folders.Add(
            new FolderViewModel(BrowseItemType.HardDisk)
            {
    ...
    public ICommand FolderSelectedCommand
    {
      get
      {
        ...
        {
          this.mFolderSelectedCommand = new RelayCommand<object>
          (p =>
          {
            try
            {
    ...
    private void SetSelectedFolder(string selectedFolder, bool updateViews)
    {
      ...
      if (updateViews == true)
      {
        ...
        if (FolderSelectionChangedEvent != null)
    ...
    private void RecentFolderRemove_Executed(object param)
    {
      ...
      if (this.RequestEditRecentFolder != null)
        this.RequestEditRecentFolder(this, new RecentFolderEvent(new PathModel(item.FolderPath, FSItemType.Folder),
