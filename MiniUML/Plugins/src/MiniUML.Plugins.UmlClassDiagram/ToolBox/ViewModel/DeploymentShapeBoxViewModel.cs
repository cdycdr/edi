namespace MiniUML.Plugins.UmlClassDiagram.ToolBox.ViewModel
{
  ...
  /// </summary>
  public class DeploymentShapeBoxViewModel : IShapBox
  {
    ...
    public DeploymentShapeBoxViewModel(PluginViewModel pluginViewModel)
    {
      var Shapes = new DeploymentCommandModels();

      foreach (var item in Shapes.GetClassLikeShapes(pluginViewModel))
      {
