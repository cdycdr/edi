namespace MiniUML.Plugins.UmlClassDiagram.ToolBox.ViewModel
{
  ...
  /// </summary>
  public class ActivityShapeBoxViewModel : IShapBox
  {
    ...
    public ActivityShapeBoxViewModel(PluginViewModel pluginViewModel)
    {
      var classShapes = new ActivityCommandModels();
