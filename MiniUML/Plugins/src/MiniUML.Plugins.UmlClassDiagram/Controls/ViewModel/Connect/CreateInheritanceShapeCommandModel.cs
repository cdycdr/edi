namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Connect
{
  ...
  /// </summary>
  public class CreateInheritanceShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    public static readonly string Name = MiniUML.Framework.Local.Strings.STR_CMD_InheritanceAssociation;
    public static readonly string Description = MiniUML.Framework.Local.Strings.STR_CMD_InheritanceAssociation_description;
    ...
    {
      this.mToolBoxImageUrl = "/MiniUML.Plugins.UmlClassDiagram;component/Images/Connect/Command.CreateInheritanceShape.png";
    ...
    public string ToolTip
    {
      get
      {
        return CreateInheritanceShapeCommandModel.Description;
      }
    }
    ...
    public string Title
    {
      get
      {
        return CreateInheritanceShapeCommandModel.Name;
      }
    }
    ...
    public void OnDragDropExecute(Point dropPoint)
    {
      ...
      model.vm_CanvasViewModel.BeginCanvasViewMouseHandler(
          new CreateAssociationMouseHandler(model, new XElement("Uml.Associations.Inheritance")));
    }
