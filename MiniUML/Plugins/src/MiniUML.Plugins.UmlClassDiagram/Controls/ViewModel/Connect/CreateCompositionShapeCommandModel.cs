namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Connect
{
  ...
  /// </summary>  
  public class CreateCompositionShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    public static readonly string Name = MiniUML.Framework.Local.Strings.STR_CMD_Composition;
    public static readonly string Description = MiniUML.Framework.Local.Strings.STR_CMD_Composition_description;
    ...
    {
      this.mToolBoxImageUrl = "/MiniUML.Plugins.UmlClassDiagram;component/Images/Connect/Command.CreateCompositionShape.png";
    ...
    public string ToolTip
    {
      get
      {
        return CreateCompositionShapeCommandModel.Description;
      }
    }
    ...
    public string Title
    {
      get
      {
        return CreateCompositionShapeCommandModel.Name;
      }
    }
