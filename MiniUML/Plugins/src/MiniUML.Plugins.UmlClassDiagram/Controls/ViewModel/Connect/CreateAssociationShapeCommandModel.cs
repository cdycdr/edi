namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Connect
{
  ...
  /// <summary>
  /// Creates a command model that has the ability to create an UML Aggreagation Connector Shape.
  /// </summary>
  public class CreateAssociationShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    public static readonly string Name = MiniUML.Framework.Local.Strings.STR_CMD_Association;
    public static readonly string Description = MiniUML.Framework.Local.Strings.STR_CMD_Association_description;
    ...
    {
      this.mToolBoxImageUrl = "/MiniUML.Plugins.UmlClassDiagram;component/Images/Connect/Command.CreateAssociationShape.png";
    ...
    public string ToolTip
    {
      get
      {
        return CreateAssociationShapeCommandModel.Description;
      }
    }
    ...
    public string Title
    {
      get
      {
        return CreateAssociationShapeCommandModel.Name;
      }
    }
