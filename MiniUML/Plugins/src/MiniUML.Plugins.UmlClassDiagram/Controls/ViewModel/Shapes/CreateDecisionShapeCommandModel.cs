namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Shapes
{
  ...
  /// </summary>
  internal class CreateDecisionShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    ...
    public CreateDecisionShapeCommandModel(PluginViewModel viewModel,
                                         string toolboxImageUrl,
                                         string shapeKey,
                                         string toolboxName,
                                         string description,
                                         double defaultWidth = 75.0,
                                         double defaultHeight = 75.0)
    {
