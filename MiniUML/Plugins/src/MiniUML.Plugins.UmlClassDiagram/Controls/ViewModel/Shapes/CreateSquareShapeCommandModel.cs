namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Shapes
{
  ...
  /// </summary>
  internal class CreateSquareShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    ...
    private readonly bool mShapeHorizontalLine = false;
    ...
    public CreateSquareShapeCommandModel(PluginViewModel viewModel,
                                         ...
                                         double defaultHeight = 95.0)
    {
      ...
      this.mShapeHorizontalLine = shapeHorizontalLine;
    ...
    public void OnDragDropExecute(Point dropPoint)
    {
      XElement element = new XElement(                         this.mShapeKey,
                         ...
                         new XAttribute("HorizontalLine"     , this.mShapeHorizontalLine),
