namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Shapes
{
  ...
  /// <summary>
  /// Creates a command model that has the ability to create an UML Use Case Shape.
  /// </summary>
  internal class CreateUseCaseShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    ...
    string mStrokeDashArray = string.Empty;
    ...
    public CreateUseCaseShapeCommandModel(PluginViewModel viewModel,
                                         ...
                                         string strokeDashArray = null)
    {
      ...
      this.mStrokeDashArray = strokeDashArray;
    }
    ...
    public void OnDragDropExecute(Point dropPoint)
    {
      XElement element = new XElement(                         this.mShapeKey,
                         ...
                         new XAttribute("StrokeDashArray"    , (this.mStrokeDashArray == null ? string.Empty : this.mStrokeDashArray)));
