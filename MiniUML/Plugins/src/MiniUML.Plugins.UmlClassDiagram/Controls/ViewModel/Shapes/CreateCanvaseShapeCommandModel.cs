namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Shapes
{
  ...
  /// </summary>
  internal class CreateCanvaseShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    ...
    private readonly PathSelector mCanvasShape = PathSelector.UmlMan;
    ...
    public CreateCanvaseShapeCommandModel(PluginViewModel viewModel,
                                         ...
                                         PathSelector canvasShape = PathSelector.UmlMan)
    {
    ...
    public void OnDragDropExecute(Point dropPoint)
    {
      XElement element = new XElement(                         this.mShapeKey,
                         new XAttribute("UmlShapeKey"        , this.mCanvasShape),
