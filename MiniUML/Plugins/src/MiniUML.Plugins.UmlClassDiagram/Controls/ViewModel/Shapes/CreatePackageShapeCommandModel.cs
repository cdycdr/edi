namespace MiniUML.Plugins.UmlClassDiagram.Controls.ViewModel.Shapes
{
  ...
  /// <summary>
  /// Creates a command model that has the ability to create an UML Package shape.
  /// </summary>
  internal class CreatePackageShapeCommandModel : CommandModelBase, IDragableCommandModel
  {
    #region fields
    ...
    double mDefaultWidth = 125.0,
           mDefaultHeight = 100.0;
    ...
    public CreatePackageShapeCommandModel(PluginViewModel viewModel,
