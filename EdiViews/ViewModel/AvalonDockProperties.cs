namespace EdiViews.ViewModels
{
  ...
  public class AvalonDockViewProperties
  {
    ...
    private PanesStyleSelector LoadPanesStyleSelector(PanesStyleSelector panesStyleSelector)
    {
      ...
      panesStyleSelector.RegisterStyle(typeof(StartPageViewModel), newStyle);
      ...
      panesStyleSelector.RegisterStyle(typeof(Log4NetViewModel), newStyle);
