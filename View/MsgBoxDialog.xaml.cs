namespace MsgBox.View
{
  ...
  public partial class MsgBoxDialog : Window
  {
                                    ...
                                    bool enableCopyFunction = false)
    {
      ...
      MsgBox.Internal.ViewModel.MsgBoxViewModel viewModel =
        new MsgBox.Internal.ViewModel.MsgBoxViewModel(messageBoxText,
                                                      caption,
                                                      details,
                                                      buttonOption,
                                                      image,
                                    ...
                                    bool enableCopyFunction = false)
    {
      ...
      // Construct the message box viewmodel
      MsgBox.Internal.ViewModel.MsgBoxViewModel viewModel =
        new MsgBox.Internal.ViewModel.MsgBoxViewModel(messageBoxText, caption,
                                                      sMess,
